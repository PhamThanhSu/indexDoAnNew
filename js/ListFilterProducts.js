...
const storedJsondaloc = localStorage.getItem('filteredProducts');
// Chuyển đổi chuỗi JSON thành mảng
const mangdaloc = JSON.parse(storedJsondaloc);
console.log(mangdaloc)
//Lấy giá trị mảng sản phẩm từ LocalStorage
const storedJsonStringhfh = localStorage.getItem('ArrayListProducts');
// Chuyển đổi chuỗi JSON thành mảng
const storedArrayyy = JSON.parse(storedJsonStringhfh);
