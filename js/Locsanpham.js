...
function handleeFilterFileresult(element) {
    ...
    var filtertest1 = document.getElementById('search').value;
  ...
  document.getElementById('filter-result').innerText = `Laptop Thiết kế - Đồ họa`;
   ...
   for (let i = 0; i < storedArray.length; i++) {
       ...
       filteredProducts.push(product);
        s +=`<div class="itemproduct" id = "itemproduct${i}">
               <div>
                   <a href="#">
               ...
               <div class="content">
                   ...
                   <div id="cpu"><img src="./sua/css/image/cpu.png" width="9%"><span>&nbsp; ${cpu}</span>
                   </div>
...
showPage(thisPageFiltersearch, paginationContainerfiltersearch);
   // Adding event listeners (if needed)
   // Example of adding event listener to each product item
  

   // Rest of your code for image hover, local storage of filtered products, etc.
}